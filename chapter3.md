...
test_function(name = "melt", 
              ...
              args_not_specified_msg = paste("Käsule `melt` läheb " , 
                                             c("esimeseks argumendiks andmestiku nimi",
                                               " üheks argumendiks  `id.vars`, mille kaudu saab määrata tunnused, mis teisendamisel paika jätta. Tunnusenimed kirjuta siin jutumärkidesse või anna ette sobivad veeruindeksid.", 
